    ...
    <div className="w-[90%] mx-auto">
      ...
      <div className="h-auto flex flex-col items-center justify-center py-12 lg:gap-6">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-around items-center gap-6 lg:gap-0 p-4 lg:p-0">
          <div className="h-[210px] w-[314px] sm:h-[312px] sm:w-[502px] lg:h-[273px] lg:w-[440px] xl:h-[312px] xl:w-[520px] bg-[#fafafa] shadow-lg flex flex-col justify-between transition-transform duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <div className="flex flex-col items-start justify-end p-3">
              <h3 className="text-[22px] sm:mb-4 sm:text-[38px] md:text-[38px] leading-[2.3rem] md:leading-[2.8rem] text-[#121316] font-semibold">
                Game Mechanics
              </h3>
              <p className="text-[16px] sm:text-[18px] md:text-[18px] lg:text-[16px] xl:text-[18px] text-[#636363]">
